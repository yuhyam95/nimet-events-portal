    ...
    if (event?.isInvitationOnly && !onSuccessfulOnboarding) {
      if (!values.invitationCode || values.invitationCode.trim() !== event.invitationCode?.trim()) {
        toast({
          ...
          description: "The invitation passcode you entered is incorrect. Please enter the passcode provided in your invitation.",
        });
        return;
      }
    }
          ...
          <FormField
            ...
            render={({ field }) => (
              <FormItem>
                ...
                <FormControl>
                  <Input placeholder="Enter passcode to register" {...field} />
                </FormControl>
                <FormDescription>
                  This is a unique, invitation-only event. Please enter the passcode provided in your invitation.
                </FormDescription>
                <FormMessage />
              </FormItem>
            )}
