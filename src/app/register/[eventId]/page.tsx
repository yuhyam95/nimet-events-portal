      ...
      <div className="min-h-screen bg-[#fcfdfd] flex items-center justify-center px-4">
        <div className="text-center max-w-md">
          <div className="flex justify-center mb-6">
            <Image src="/nimet-logo.png" alt="NIMET Logo" width={120} height={120} className="object-contain" />
          </div>
          <h1 className="text-2xl font-bold text-primary mb-3">{event.name}</h1>
          <p className="text-muted-foreground text-lg mb-2">Registration is not open for this event.</p>
          <p className="text-sm text-muted-foreground">Attendance for this event is managed by staff on-site.</p>
        </div>
      </div>
    );
  }
